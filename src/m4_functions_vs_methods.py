...
def try_methods():
    ivanivanovichivanovsky = rg.SimpleTurtle()
    ivanivanovichivanovsky.pen = rg.Pen('brown', 5)
    ivanivanovichivanovsky.forward(150)
    ivanivanovichivanovsky.left(90)
    ivanivanovichivanovsky.forward(50)
    ivanivanovichivanovsky.backward(100)
    """
...
def try_methods_and_functions():
    runningoutofcreativenames = rg.SimpleTurtle()
    runningoutofcreativenames.pen = rg.Pen('blue', 5)

    runningoutofcreativenames.backward(150)
    runningoutofcreativenames.speed = 1
    draw_many_squares(runningoutofcreativenames, 2, 100, 30)

    runningoutofcreativenames.speed = 5
    runningoutofcreativenames.pen = rg.Pen('red', 5)
    draw_many_squares(runningoutofcreativenames, 10, 50, 15)

    runningoutofcreativenames.speed = 100
    runningoutofcreativenames.pen = rg.Pen('red', 35)
    draw_many_squares(runningoutofcreativenames, 8, 300, 60)

    runningoutofcreativenames.pen = rg.Pen('black', 3)
    runningoutofcreativenames.backward(200)
    runningoutofcreativenames.draw_circle(30)
    runningoutofcreativenames.draw_square(50)
