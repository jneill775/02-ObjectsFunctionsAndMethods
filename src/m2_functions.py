...
#
###############################################################################
def penFunc(color, thicc):
    window = rg.TurtleWindow()
    kaiservonwilhelmIIIkingofprussiaandthelastgermankaiser = rg.SimpleTurtle()
    deceasedunitedstatespresidentjameskpolk = rg.SimpleTurtle()
    kaiservonwilhelmIIIkingofprussiaandthelastgermankaiser.pen = rg.Pen('green', thicc)
